...
"$BT/aapt2" link   -o "$BUILD/base.apk"   -I "$PLATFORM"   --manifest "$ROOT/app/src/main/AndroidManifest.xml"   --min-sdk-version 29   --target-sdk-version 35   --version-code 6   --version-name 6.0
...
"$BT/zipalign" -f -p 4 "$BUILD/unsigned.apk" "$DIST/Natural-Translator-AI-Rector-v6-UNSIGNED.apk"

echo "Built: $DIST/Natural-Translator-AI-Rector-v6-UNSIGNED.apk"
sha256sum "$DIST/Natural-Translator-AI-Rector-v6-UNSIGNED.apk"
