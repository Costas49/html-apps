...
final class ApiKeyVault {
    private static final String STORE = "brilliance_secure_settings";
    private static final String ALIAS = "brilliance_gemini_key";
    private static final String VALUE = "api_key_cipher";
    private static final String IV = "api_key_iv";
    private final SharedPreferences preferences;

    ApiKeyVault(Context context) {
